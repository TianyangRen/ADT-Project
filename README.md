...
Adaptive execution sequence source file (`docs/diagrams/adaptive_execution_sequence.mmd`):
...
Strategy selection state source file (`docs/diagrams/strategy_selection_state.mmd`):
...
Offline-online closed loop source file (`docs/diagrams/offline_online_closed_loop.mmd`):
